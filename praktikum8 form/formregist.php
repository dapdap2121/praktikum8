...
<?php
    ...
    <div class="container">
        <div class="row">
            ...
            <h5 class="alert alert-primary mt-2">Registrasi Peserta Didik</h5>
                <div class="card">
                <div class="card-body">
                    <form method="post" action="prosesregist.php">
                    
                    <div class="form-group row">
                        <label for="web" class="col-sm-2 col-form-label">Tanggal Pengisian</label>
                        <div class="col-sm-10">
                            <input type="date" name="tglisi" id="tglisi" class="form-control <?php echo ($error_tglisi !="" ? "is-invalid" : ""); ?>" 
                            placeholder="" value="<?php echo $tglisi; ?>"> 
                            <span class="warning"><?php echo $error_tglisi ?></span>
                        </div>
                    </div>
                    <br>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="date" name="tglmsksklh" id="tglmsksklh" class="form-control <?php echo ($error_tglmsksklh !="" ? "is-invalid" : ""); ?>" 
                            placeholder="" value="<?php echo $tglmsksklh; ?>"> <span class="warning"><?php echo $error_tglmsksklh ?></span>
                        </div>
                    </div>
                    <br>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="nis" id="nis" class="form-control <?php echo ($error_nis !="" ? "is-invalid" : ""); ?>" 
                            placeholder="Masukkan NIS anda" value="<?php echo $nis; ?>"> 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="nopesujian" id="nopesujian" class="form-control <?php echo ($error_nopesujian !="" ? "is-invalid" : ""); ?>" 
                            placeholder="Masukkan No peserta ujian anda" value="<?php echo $nopesujian; ?>"> 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="noserskhun" id="noserskhun" class="form-control <?php echo ($error_noserskhun !="" ? "is-invalid" : ""); ?>" 
                            placeholder="Masukkan No seri SKHUN sebelumnya" value="<?php echo $noserskhun; ?>"> 
                            <span class="warning"><?php echo $error_noserskhun ?></span>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="noserijazah" id="noserijazah" class="form-control <?php echo ($error_noserijazah !="" ? "is-invalid" : ""); ?>" 
                            placeholder="Masukkan No seri ijazah sebelumnya" value="<?php echo $noserijazah; ?>"> 
                            <span class="warning"><?php echo $error_noserijazah ?></span>
                        </div>
                    </div>
