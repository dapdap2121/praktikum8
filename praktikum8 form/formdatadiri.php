...
<?php
    ...
    <div class="container">
        <div class="row">
            <h4 class="alert alert-primary text-center mt-3">Formulir Peserta Didik</h4>
            <h5 class="alert alert-primary mt-2">Data Pribadi</h5>
                <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="namaleng" id="namaleng" class="form-control <?php echo ($error_namaleng !="" ? "is-invalid" : ""); ?>" 
                            placeholder="Masukkan nama anda" value="<?php echo $namaleng; ?>"> 
                            <span class="warning"><?php echo $error_namaleng ?></span>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="nisn" id="nisn" class="form-control <?php echo ($error_nisn !="" ? "is-invalid" : ""); ?>" 
                            placeholder="Masukkan NISN anda" value="<?php echo $nisn; ?>"> 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="nik" id="nopesunikjian" class="form-control <?php echo ($error_nik !="" ? "is-invalid" : ""); ?>" 
                            placeholder="Masukkan NIK anda" value="<?php echo $nik; ?>"> 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="tlahir" id="tlahir" class="form-control <?php echo ($error_tlahir !="" ? "is-invalid" : ""); ?>" 
                            placeholder="Masukkan tempat lahir anda" value="<?php echo $tlahir; ?>"> 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="date" name="tglahir" id="tglahir" class="form-control <?php echo ($error_tglahir !="" ? "is-invalid" : ""); ?>" 
                            placeholder="" value="<?php echo $tglahir; ?>"> 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="alamat" id="alamat" class="form-control <?php echo ($error_alamat !="" ? "is-invalid" : ""); ?>" 
                            placeholder="Masukkan alamat anda" value="<?php echo $alamat; ?>"> 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="rt" id="rt" class="form-control <?php echo ($error_rt !="" ? "is-invalid" : ""); ?>" 
                            placeholder="" value="<?php echo $rt; ?>"> 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="rw" id="rw" class="form-control <?php echo ($error_rw !="" ? "is-invalid" : ""); ?>" 
                            placeholder="" value="<?php echo $rw; ?>"> 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="namadusun" id="namadusun" class="form-control <?php echo ($error_namadusun !="" ? "is-invalid" : ""); ?>" 
                            placeholder="" value="<?php echo $namadusun; ?>"> 
                            <span class="warning"><?php echo $error_namadusun ?></span>
                        </div>
                    </div> 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="namakel" id="namakel" class="form-control <?php echo ($error_namakel !="" ? "is-invalid" : ""); ?>" 
                            placeholder="" value="<?php echo $namakel; ?>"> 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="kec" id="kec" class="form-control <?php echo ($error_kec !="" ? "is-invalid" : ""); ?>" 
                            placeholder="" value="<?php echo $kec; ?>"> 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="kodepos" id="kodepos" class="form-control <?php echo ($error_kodepos !="" ? "is-invalid" : ""); ?>" 
                            placeholder="" value="<?php echo $kodepos; ?>"> 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="nohp" id="nohp" class="form-control <?php echo ($error_nohp !="" ? "is-invalid" : ""); ?>" 
                            placeholder="Masukkan No HP anda" value="<?php echo $nohp; ?>"> 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="notelp" id="notelp" class="form-control <?php echo ($error_notelp !="" ? "is-invalid" : ""); ?>" 
                            placeholder="Masukkan No Telp anda" value="<?php echo $notelp; ?>"> 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="email" id="email" class="form-control <?php echo ($error_email !="" ? "is-invalid" : ""); ?>" 
                            placeholder="Masukkan email anda" value="<?php echo $email; ?>"> 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="nokpspkh" id="nokpspkh" class="form-control <?php echo ($error_nokpspkh !="" ? "is-invalid" : ""); ?>" 
                            placeholder="Masukkan Nomor KPS/PKH/KIP jika ada" value="<?php echo $nokpspkh; ?>"> 
                            <span class="warning"><?php echo $error_nokpspkh ?></span>
                        </div>
                    </div> 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="namaneg" id="namaneg" class="form-control <?php echo ($error_namaneg !="" ? "is-invalid" : ""); ?>" 
                            placeholder="Masukkan nama negara anda" value="<?php echo $namaneg; ?>">
                             <span class="warning"><?php echo $error_namaneg ?></span>
                        </div>
                    </div>
